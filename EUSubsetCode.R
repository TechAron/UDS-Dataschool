...
EU_tok <- tokens_select(tok,c("EU", "euroscepticus", "juncker", "brexit", "nexit", "^e(u|urope(es|se))$", "boris_johnson", "^may$"), selection = "keep", padding = FALSE) #hij is een beetje aangepast. HIerdoor werd de LDA relevanter, met vaker dingen over advocaten, rechters, stoornissen et cetera. Psychiaters en ontsnappingen zijn eruit. 
newthingEU <- ntoken(EU_tok) #telt het aantal voorkomens van één van de woorden op de woordenlijst per artikel
