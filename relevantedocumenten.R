...
newthing <- ntoken(migr_tok)
vluchtelingen_bool <- newthing > 0L

sept_C <- september_corpus
docvars(sept_C, "vluchtelingen") <- vluchtelingen_bool

vlucht_sept <- corpus_subset(sept_C, vluchtelingen == TRUE)